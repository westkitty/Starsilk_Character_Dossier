# Starsilk Compendium — faceted discovery index

Human discovery: https://westkitty.github.io/Starsilk_Character_Dossier/discover/
JSON discovery index: https://westkitty.github.io/Starsilk_Character_Dossier/discover/discovery.json
Context packet register: https://westkitty.github.io/Starsilk_Character_Dossier/discover/context-packets.json
Authority: https://westkitty.github.io/Starsilk_Character_Dossier/discover/AUTHORITY.md
...
|---|---|---|---|---:|---|
| `cover` | Visual reference | `section` | Overview | 2 | https://westkitty.github.io/Starsilk_Character_Dossier/discover/packets/cover.json |
...
| `dao` | Dao | `character-section` | Principal characters | 1 | https://westkitty.github.io/Starsilk_Character_Dossier/discover/packets/dao.json |
...
| `vessa` | Vessa | `character-section` | — | 0 | https://westkitty.github.io/Starsilk_Character_Dossier/discover/packets/vessa.json |
| `orin` | Orin | `character-section` | — | 0 | https://westkitty.github.io/Starsilk_Character_Dossier/discover/packets/orin.json |
| `mael` | Mael | `character-section` | — | 0 | https://westkitty.github.io/Starsilk_Character_Dossier/discover/packets/mael.json |
| `sera-inventory` | Sera | `character-section` | — | 0 | https://westkitty.github.io/Starsilk_Character_Dossier/discover/packets/sera-inventory.json |
| `hesh` | Hesh | `character-section` | — | 0 | https://westkitty.github.io/Starsilk_Character_Dossier/discover/packets/hesh.json |
| `mara` | Mara | `character-section` | — | 0 | https://westkitty.github.io/Starsilk_Character_Dossier/discover/packets/mara.json |
| `rin` | Rin | `character-section` | — | 0 | https://westkitty.github.io/Starsilk_Character_Dossier/discover/packets/rin.json |
| `kira` | Kira | `character-section` | — | 0 | https://westkitty.github.io/Starsilk_Character_Dossier/discover/packets/kira.json |
| `jalen` | Jalen | `character-section` | — | 0 | https://westkitty.github.io/Starsilk_Character_Dossier/discover/packets/jalen.json |
| `safi` | Safi | `character-section` | — | 0 | https://westkitty.github.io/Starsilk_Character_Dossier/discover/packets/safi.json |
| `kaelen` | Kaelen | `character-section` | — | 0 | https://westkitty.github.io/Starsilk_Character_Dossier/discover/packets/kaelen.json |
| `lyra` | Lyra | `character-section` | — | 0 | https://westkitty.github.io/Starsilk_Character_Dossier/discover/packets/lyra.json |
| `rhys` | Rhys | `character-section` | — | 0 | https://westkitty.github.io/Starsilk_Character_Dossier/discover/packets/rhys.json |
| `anya` | Anya | `character-section` | — | 0 | https://westkitty.github.io/Starsilk_Character_Dossier/discover/packets/anya.json |
| `sela-orrin` | Sela Orrin | `character-section` | — | 0 | https://westkitty.github.io/Starsilk_Character_Dossier/discover/packets/sela-orrin.json |
| `marn` | Marn | `character-section` | — | 0 | https://westkitty.github.io/Starsilk_Character_Dossier/discover/packets/marn.json |
| `joss` | Joss | `character-section` | — | 0 | https://westkitty.github.io/Starsilk_Character_Dossier/discover/packets/joss.json |
| `reth` | Reth | `character-section` | — | 0 | https://westkitty.github.io/Starsilk_Character_Dossier/discover/packets/reth.json |
...
| `marshal-venn` | Marshal Venn | `character-section` | — | 0 | https://westkitty.github.io/Starsilk_Character_Dossier/discover/packets/marshal-venn.json |
| `administrator-pell` | Administrator Pell | `character-section` | — | 0 | https://westkitty.github.io/Starsilk_Character_Dossier/discover/packets/administrator-pell.json |
| `technician-naresh` | Technician Naresh | `character-section` | — | 0 | https://westkitty.github.io/Starsilk_Character_Dossier/discover/packets/technician-naresh.json |
| `captain-serr` | Captain Serr | `character-section` | — | 0 | https://westkitty.github.io/Starsilk_Character_Dossier/discover/packets/captain-serr.json |
| `harold` | Harold | `character-section` | — | 0 | https://westkitty.github.io/Starsilk_Character_Dossier/discover/packets/harold.json |
| `mara-syrin4` | Mara — Syrin-4 | `character-section` | — | 0 | https://westkitty.github.io/Starsilk_Character_Dossier/discover/packets/mara-syrin4.json |
| `tomas` | Tomas | `character-section` | — | 0 | https://westkitty.github.io/Starsilk_Character_Dossier/discover/packets/tomas.json |
| `jonah` | Jonah | `character-section` | — | 0 | https://westkitty.github.io/Starsilk_Character_Dossier/discover/packets/jonah.json |
| `clara` | Clara | `character-section` | — | 0 | https://westkitty.github.io/Starsilk_Character_Dossier/discover/packets/clara.json |
| `eli` | Eli | `character-section` | — | 0 | https://westkitty.github.io/Starsilk_Character_Dossier/discover/packets/eli.json |
| `ruth-syrin4` | Ruth | `character-section` | — | 0 | https://westkitty.github.io/Starsilk_Character_Dossier/discover/packets/ruth-syrin4.json |
| `kails-mother` | Kail’s Mother | `character-section` | — | 0 | https://westkitty.github.io/Starsilk_Character_Dossier/discover/packets/kails-mother.json |
| `cosmic-architecture` | Prisons, repositories, scars and places that remember. | `section` | Peripheral & cosmic | 0 | https://westkitty.github.io/Starsilk_Character_Dossier/discover/packets/cosmic-architecture.json |
| `worldsvault-templates` | Thirty templates. Twenty-one currently named. | `section` | Peripheral & cosmic | 0 | https://westkitty.github.io/Starsilk_Character_Dossier/discover/packets/worldsvault-templates.json |
| `ontology-horror` | The operating system has moral consequences. | `section` | Peripheral & cosmic | 0 | https://westkitty.github.io/Starsilk_Character_Dossier/discover/packets/ontology-horror.json |
| `artifacts-factions` | Tools remember what systems ask them to do. | `section` | Peripheral & cosmic | 0 | https://westkitty.github.io/Starsilk_Character_Dossier/discover/packets/artifacts-factions.json |
| `trio-gallery` | Three protagonists under impossible pressure. | `section` | Peripheral & cosmic | 12 | https://westkitty.github.io/Starsilk_Character_Dossier/discover/packets/trio-gallery.json |
| `history-media` | The ledger has pictures. The text still governs. | `section` | Peripheral & cosmic | 2 | https://westkitty.github.io/Starsilk_Character_Dossier/discover/packets/history-media.json |
| `media-vault` | Media Vault | `media-vault-section` | Peripheral & cosmic | 63 | https://westkitty.github.io/Starsilk_Character_Dossier/discover/packets/media-vault.json |
| `archive` | Reference art belongs beside the canon it can contradict. | `archive-section` | Reference | 0 | https://westkitty.github.io/Starsilk_Character_Dossier/discover/packets/archive.json |
| `source` | Codec: the architecture of necessary harm. | `source-section` | Reference | 0 | https://westkitty.github.io/Starsilk_Character_Dossier/discover/packets/source.json |
