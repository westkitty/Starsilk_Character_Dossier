...
def build_project_index(records: list[dict], relationship_count: int) -> dict:
    ...
    return {
        ...
        "endpoints": {
            ...
            "film_vault": canonical("films/"),
            "film_vault_index": canonical("films/films.json"),
