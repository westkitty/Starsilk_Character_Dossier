...
- Pinned Linux visual regression, protected PR CI, merge state, Pages publication, and live-edge parity remain pending and must not be inferred from local proof.
