...
LATE_JS = """
  ...
  (function(){
    ...
    // Safety net: never block the site open for more than ~1.2s even if
    // autoplay is blocked, the video errors silently, there is no hero
    // video at all, or 'playing' never fires for some other reason.
